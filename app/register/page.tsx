    ...
    <div className="min-h-screen flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h2 className="text-2xl font-semibold text-[#2C1810] mb-2">Create Account</h2>
          <p className="text-[#5D4037]">Start managing your schedules smarter</p>
        </div>
          ...
          <CardBody className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-sm text-[#5D4037]">
                ...
                <Link href="/terms" className="text-[#8D6E63] hover:text-[#6F4E42]">
                  Terms of Service
                </Link>{' '}
                and{' '}
                <Link href="/privacy" className="text-[#8D6E63] hover:text-[#6F4E42]">
                  Privacy Policy
                </Link>
              </div>
